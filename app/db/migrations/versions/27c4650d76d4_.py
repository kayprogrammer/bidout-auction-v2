...
Revision ID: 27c4650d76d4
Revises: 
Create Date: 2023-11-23 17:04:30.491477
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('pkid'),
    sa.UniqueConstraint('id'),
    sa.UniqueConstraint('session_key', 'listing_id', name='unique_session_key_listing_watchlists'),
    sa.UniqueConstraint('user_id', 'listing_id', name='unique_user_listing_watchlists')
    )
